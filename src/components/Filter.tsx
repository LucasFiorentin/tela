...
export function Filter() {
  return (
    <div className="h-[100px] w-full bg-[#F9F1E7] flex items-center ">
      ...
      <div className="gap-3 ml-[260px] flex justify-center items-center pl-44">
        <p className="font-normal text-[20px] leading-7">Show</p>
        <div className=" bg-white ">
          <input
            className="p-3 pt-1 text-[20px] pb-1 w-11 border-none outline-none text-[#9F9F9F]"
            type="text"
            placeholder="16"
          />
        </div>
      ...
      <div className="gap-3 ml-[40px] flex justify-center items-center mr-[93px]">
        ...
        <div className=" bg-white ">
          <input
            className="p-3 pt-1 text-[20px] pb-1 w-24 border-none outline-none text-[#9F9F9F]"
            type="text"
            placeholder="Default"
          />
        </div>
